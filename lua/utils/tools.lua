...
R.convert_current_word_to_binary = function()
  H.convert_current_word_to_x(H.str_decimal_to_binary)
end

R.convert_current_word_to_decimal = function()
  H.convert_current_word_to_x(H.binary_to_decimal)
end
